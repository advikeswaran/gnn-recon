"""
plot_summary_emb_interp_T_inflated.py -- Summary plots for homoscedastic + embeddings reconstruction.
...
plt.tight_layout()
plt.savefig(str(PLOT_DIR/'summary_emb_interp_T_inflated.png'), dpi=150, bbox_inches='tight')
print(f'Saved summary_emb_interp_T_inflated.png')
