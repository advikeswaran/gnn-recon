"""
plot_spatial_trends_homo.py -- Spatial trend maps for homoscedastic model reconstruction.
Reads from cache/recon_homo/. Outputs to cache/plots/homo/
"""
...
for yi, yr in enumerate(recon_years):
    r = np.load(str(RECON_DIR/'cache'/'recon_homo'/f'recon_{yr}.npy'))
...
plt.tight_layout()
plt.savefig(str(PLOT_DIR/'spatial_trends_homo.png'), dpi=150, bbox_inches='tight')
print('Saved spatial_trends_homo.png')
