"""
plot_spatial_trends_homo_inflated.py -- Spatial trend maps for homoscedastic model reconstruction.
Reads from cache/recon_homo_inflated/. Outputs to cache/plots/homo_inflated/
"""
...
for yi, yr in enumerate(recon_years):
    r = np.load(str(RECON_DIR/'cache'/'recon_homo_inflated'/f'recon_{yr}.npy'))
...
plt.tight_layout()
plt.savefig(str(PLOT_DIR/'spatial_trends_homo_inflated.png'), dpi=150, bbox_inches='tight')
print('Saved spatial_trends_homo_inflated.png')
