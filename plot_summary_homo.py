"""
plot_summary_homo.py -- Summary plots for homoscedastic model reconstruction.
...
plt.tight_layout()
plt.savefig(str(PLOT_DIR/'summary_homo.png'), dpi=150, bbox_inches='tight')
print(f'Saved summary_homo.png')
