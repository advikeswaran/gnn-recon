"""
plot_summary_homo_inflated.py -- Summary plots for homoscedastic model reconstruction.
...
plt.tight_layout()
plt.savefig(str(PLOT_DIR/'summary_homo_inflated.png'), dpi=150, bbox_inches='tight')
print(f'Saved summary_homo_inflated.png')
