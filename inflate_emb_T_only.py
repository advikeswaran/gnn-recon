"""
inflate_emb_T_only.py -- Apply per-node variance inflation to T only.
P is taken directly from recon_emb/ unchanged.
Output: cache/recon_emb_T_inflated/
"""
import numpy as np
...
IN_DIR    = RECON_DIR / 'cache' / 'recon_emb'
OUT_DIR   = RECON_DIR / 'cache' / 'recon_emb_T_inflated'
