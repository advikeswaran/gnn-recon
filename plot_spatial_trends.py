"""
plot_spatial_trends.py -- Spatial trend maps for T and SMB.
"""
...
plt.tight_layout()
plt.savefig(str(PLOT_DIR/'spatial_trends.png'), dpi=150, bbox_inches='tight')
print('Saved spatial_trends.png')
