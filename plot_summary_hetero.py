"""
plot_summary_hetero.py -- Summary plots for heteroscedastic model reconstruction.
...
plt.tight_layout()
plt.savefig(str(PLOT_DIR/'summary_hetero.png'), dpi=150, bbox_inches='tight')
print(f'Saved summary_hetero.png')
